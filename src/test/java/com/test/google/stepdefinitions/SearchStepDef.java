...
public class SearchStepDef {
    ...
    public void user_validates_first_page_returns_more_ten_links() throws InterruptedException {
    ...
    public void user_search_for_turkish_baklava() {
        googleMainPage.searchItem("Turkish Baklava");
    }
    @Then("User validates page loads less than one second")
    public void user_validates_page_loads_less_than_one_second() {
        Assert.assertTrue(googleMainPage.baklavaSearch(1.0));
    }
